...
(6, 'Hammerhead Crocodile', 'A', 'Advanced Dawn Hunt', '1/5', 'Kozama''uka', 'Uyuyub''', 'X:11, Y:9', 'NW of Ok''hanu — watch for Beginner-rank nearby', 1, '1,500 Gil · 15 Sacks of Nuts · 471,744 EXP', 'Dawn Hunt', ARRAY['1 target — soloable.', 'NW of Ok''hanu at X:11 Y:9.', 'Caution: a Beginner-rank Hammerhead Crocodile roams nearby — different bill tier.'], 'todo'),
(7, 'Yak T''el Squib', 'A', 'Advanced Dawn Hunt', '2/5', 'Yak T''el', 'Iq Rrax Tsoly', '~X:28, Y:20', 'Roams the lake area', 2, '1,500 Gil · 15 Sacks of Nuts · 471,744 EXP', 'Dawn Hunt', ARRAY['2 targets — kill both to complete.', 'Found around the Iq Rrax Tsoly lake area.'], 'done'),
(8, 'Turali Hawksbill', 'A', 'Advanced Dawn Hunt', '3/5', 'Shaaloani', 'Pyariyoanaan Plain', '~X:20, Y:30', 'Roams open plains area', 2, '1,500 Gil · 15 Sacks of Nuts · 471,744 EXP', 'Dawn Hunt', ARRAY['2 targets — kill both to complete.', 'Large turtles on the Pyariyoanaan Plain.', 'Open terrain — visible from a distance.'], 'todo'),
(9, 'Defective Turret', 'A', 'Advanced Dawn Hunt', '4/5', 'Heritage Found', 'East Yyasulani', '~X:30, Y:15', 'Roams east sector', 3, '1,500 Gil · 15 Sacks of Nuts · 471,744 EXP', 'Dawn Hunt', ARRAY['3 targets — kill all 3 to complete.', 'Mechanical enemies in East Yyasulani.', 'Watch for explosive attacks.'], 'todo'),
(10, 'Matchlock Scorpion', 'A', 'Advanced Dawn Hunt', '5/5', 'Living Memory', 'Matchlock Menagerie', '~X:25, Y:20', 'Roams Matchlock Menagerie', 1, '1,500 Gil · 15 Sacks of Nuts · 471,744 EXP', 'Dawn Hunt', ARRAY['1 target — soloable.', 'Found in the Matchlock Menagerie section of Living Memory.', 'Vilekin-type — watch for poison attacks.'], 'todo'),
(11, 'Chupacabra', 'S', 'Elite Dawn Hunt', 'Weekly', 'Urqopacha', 'Urqopacha', 'X:16-32, Y:8-30', 'Multiple spawn points — use Faloop or hunt Discord', 1, '5,000 Gil · 100 Sacks of Nuts', 'Dawn Hunt', ARRAY['Weekly Elite mark — massive rewards.', 'Watch for Triclip — telegraphed column AoE.', 'Group up — tough solo.', 'Use Faloop.app or hunt Discord for live callouts.', 'Respawns 5 seconds after previous kill.'], 'todo'),
