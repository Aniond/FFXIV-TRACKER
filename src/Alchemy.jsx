...
const LIST_KEY  = 'ffxiv-alchemy-list'
...
export default function Alchemy() {
  ...
  // Deep-link from Centurio AI: /crafting/alchemy?ingredient=Flint+Corn shows
  ...
  // Deep-link from Centurio AI: /crafting/alchemy?recipe=Caramel+Popcorn scrolls
  ...
  useEffect(() => {
    document.body.classList.add('alchemy-page')
    return () => document.body.classList.remove('alchemy-page')
  }, [])

  useEffect(() => {
    fetchRecipes({ job: 'ALC', expansion: 'Dawntrail' })
      .then((rs) => {
  ...
  return (
    <div className="ledger">
      ...
      <header className="brand">
        ...
        <div>
          <h1 className="brand__title">ALCHEMY LOG</h1>
